 ...
 * generated in the publishws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Multiply_QNAME = new QName("http://PublishWS/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://PublishWS/", "multiplyResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: publishws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://PublishWS/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://PublishWS/", name = "multiplyResponse")
