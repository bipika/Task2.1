 ...
 * 
 */
@WebServiceClient(name = "PServiceImplService", targetNamespace = "http://PublishWS/", wsdlLocation = "http://localhost:8084/MyServices/pservice?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PSERVICEIMPLSERVICE_QNAME = new QName("http://PublishWS/", "PServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/MyServices/pservice?WSDL");
    ...
    public PServiceImpl getPServiceImplPort() {
        return super.getPort(new QName("http://PublishWS/", "PServiceImplPort"), PServiceImpl.class);
    }
    ...
    public PServiceImpl getPServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://PublishWS/", "PServiceImplPort"), PServiceImpl.class, features);
    }
